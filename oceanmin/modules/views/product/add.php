                                        ...
                                        'clientOptions' => [
                                            ...
                                            'toolbars' => [
                                                [
                                                  ...
                                                  'insertframe', 'pagebreak', 'template', '|',
                                                    'horizontal', 'spechars'
                                                ],
                                            ]
                                    ]]);?>
                                    </div>
                                    <!-- <textarea id="wysi" class="span9 wysihtml5" name="Product[features]" style="margin-left:120px">
                                    <?php echo $model['features'];?>
                                    </textarea> -->
                                </div>
                            </div>
                            <div class="form-group field-wysi required" style="display: none">
                                <div class="span12 field-box">
                                    <label class="control-label" for="wysi">商品描述</label>
                                    <textarea id="wysi1" class="span9 wysihtml5" name="Product[description]" style="margin-left:120px">
                                    <?php echo $model['description'];?>1
                                    </textarea>
                                </div>
                            </div>
                            <div class="form-group field-wysi required">
