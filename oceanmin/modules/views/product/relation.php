                    ...
                    <div class="container">
                        ...
                        <div class="form-group field-product-title required">
                            <div class="span12 field-box">
                                <h4 class="control-label">当前商品ID：<strong><?php echo Html::encode($product['productid']);?></strong></h4>
                                <h4 class="control-label">当前商品名称：<strong><?php echo Html::encode($product['title']);?></strong></h4>
                                <? if (isset($resnew)) :?>
                                <h4 class="control-label">当前商品关联的产品有：
                                    <?php foreach($resnew as $r):?>
                                        <strong>商品<?php echo $r['productid']?> </strong>
                                    <?php endforeach;?>
                                </h4>
                                <? else: ?>
                                <h4 class="control-label"><strong>当前商品无关联商品</strong></h4>
                                <? endif ?>
                            ...
                            <h3>选择关联商品</h3>
                            <input type="text" id="pl" name="<?php echo Html::encode($product['productid']);?>" value="" placeholder="请点击此处，但不要填写内容">
